...
var FuncMap = map[string]func(shim.ChaincodeStubInterface, []string) peer.Response{
	...
	"RetrieveAcceptedPapersByUploader":  retrieve.AcceptedPapersByUploader,
	"RetrieveRejectedPapersByUploader":  retrieve.RejectedPapersByUploader,
	"RetrieveReviewingPapersByUploader": retrieve.ReviewingPapersByUploader,
